...
<head>
  ...
  <title>Bookseeking - Post Details</title>
...
<!-- Header Area Starts -->
<section>
  <div class="container" style="height: 160px; margin-top: -100px; margin-bottom:100px;" >
    <div class="row">
      <div class="col-md-12">
...
<h1> Himu Mama </h1> 
<span class="category">Novel </span> <span class="item-location"><i class="fa fa-map-marker"></i> Dhanmondi</span> </span>


<div class="ads-image"> <br>
<h1 class="price"> BDT 0</h1>



<ul>
<li><img src="images/himumama.jpg" alt="img" style="width: 300px; height: 400px; margin-top: 50px; margin-bottom: 50px; " /></li>
</ul>
</div>
...
<h5 class='#'><strong> Author </strong> </h5> 
<span class="#"> Humayun Ahmed </span> <br> <br>
<h5 class='#'><strong> Publisher </strong> </h5> 
<span class="#"> Onno Prokash </span> <br> <br>

<h5 class="list-title"><strong>Book Details</strong></h5>
<div class="row">
<div class="ads-details-info col-md-8">
<p>Bought this book from this year boimela. Now I want to exchange the book with anothe novel of Humayun Ahmed. Prefrerred books are Misir Ali or other Himu books. </p>
</div>
<div class="col-md-4">
<aside class="panel panel-body panel-details">
<ul>
<li>
<p class=" no-margin "><strong>Edition:</strong> 4th</p>
</li>
<li>
<p class="no-margin"><strong>ISBN:</strong> 162-736-746</p>
</li>
<li>
<p class="no-margin"><strong>Category:</strong> Novel </p>
</li>
<li>
<p class=" no-margin "><strong>Deal Type:</strong> Exchange</p>
</li>
</ul>
</aside>
</div>
...
<div class="#"><a class="btn  btn-success bg-info"> Contact Number </a> <a class="btn  btn-success"><i class=" icon-phone-1"></i> 01680 531 352 </a></div>
</div>
</div>
...
<h3 class="no-margin">Raiyad Raad</h3>
<p>Location: <strong>Dhanmondi</strong></p>
...
<span style="font-size: 30px;">01680 531 352</span>
