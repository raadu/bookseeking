...
$sql = "SELECT bookpic,bookname,author,publisher,dealname,catname,price FROM bookinfo ORDER BY bookid DESC;";
...
<meta charset="utf-8">
  ...
  <title>Bookseeking - My Posts</title>
...
<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo"  style="margin-top: 145px;">
<thead>
<tr>
<th> Photo</th>
<th> Book Details</th>
...
<tr>
<td style="width:35%" class="add-img-td"><a href="ads-details.html"><img class="thumbnail  img-responsive" src="images/himumama.jpg" alt="img" style="height: 250px; width: 250px;"></a></td>
<td style="width:70%" class="ads-details-td">
<div>
<p><strong> <a href="post-details.php"> <?php echo $row['bookname']; ?> </a> </strong></p>
<p><strong> Author </strong>:
<?php echo $row['author']; ?> </p>
<p><strong> Category </strong>: <?php echo $row['catname']; ?> </p> 
<p> <strong>Deal Type</strong> <?php echo $row['dealname']; ?> </p>
</div>
</td>
...
<div>
<p style="color: black;"><a class="btn btn-success bg-info" style="width: 130px;"> <i class="fa fa-edit"></i> Edit </a>
</p>
<p style="color: black;"><a class="btn btn-success bg-success" style="width: 130px;"> <i class="fa fa-mail-forward"></i> Share
</a></p>
<p style="color: black;"><a class="btn btn-success bg-danger" style="width: 130px;"> <i class=" fa fa-trash"></i> Delete
</a>
</p>
</div>
</td>
