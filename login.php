    ...
    <section id="content" style="margin-bottom: 50px;">
      ...
      <?php if(isset($fmsg)){ ?><div class="alert alert-danger" role="alert"> <?php echo $fmsg; ?> </div><?php } ?>
            <!-- PHP Alert Box ends -->
              ...
              <ul class="form-links"">
                <li class="pull-left"> <a class="add-button" href="signup.php" style="background-color:  #76448a "> No account? Register Here!</a> </li>
                
                <li class="pull-right"><a class="add-button" href="forget-password.html" style="background-color:  #b03a2e "> Lost Your Password?</a></li>
              </ul>
            </div>
          </div> 
        </div>
